...
class Client:
    ...
    def __init__(self, user):
        ...
        send_button = Button(self.right_part, text='Отправить сообщение', command=self.send_message)
    ...
    def update_contacts(self):
        ...
        if contacts:
            for contact in contacts:
                ...
                start_chat = Button(cont_field, text='Начать чат', command=lambda x=contact[1]: self.start_chat(x))
